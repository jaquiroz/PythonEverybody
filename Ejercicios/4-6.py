...
# should be 498.75). You should use input to read a string and float() 
# to convert the string to a number. Do not worry about error checking 
...
try:
    ...
    rate= input("Ingrerse el pago por hora: ")
    h=float(hora)
    r=float(rate)
    p = pago(h,r)
    print("Pay",p)
    ...
    print("Error, Por favor ingrese numeros")
    quit()